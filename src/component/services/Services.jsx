            ...
            <div className="services__container container grid">
                            ...
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    ...
                                    <p className="services__modal-info">
                                        I develop user flows and wireframes.
                                    </p>
                                </li>
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                ...
                <div className="services__content">
                    <div>
                        ...
                        <h3 className="services__title">App <br /> Design</h3>
                    </div>
                    ...
                    <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <h3 className="services__modal-title">App Design</h3>
                            <p className="services__modal-description">
                                Service with more than a year of experience.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        I develop ideas for what your app might look like.
                                    </p>
                                </li>
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        Link between users and developer.
                                    </p>
                                </li>
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Service with up to 2 years of experience. Providing quality work to clients and companies.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
