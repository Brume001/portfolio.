                ...
                <div className="qualification__sections">
                    <div className={
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">High School Edu. at O.S.S</h3>
                                <span className="qualification__subtitle">Nigeria </span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calender"></i>2015 - 2020
                                </div>
                            </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">Nigeria - Great Learning </span>
                                <div className="qualification__calender">
